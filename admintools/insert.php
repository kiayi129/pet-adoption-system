...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO users_information (username, email, phonenumber, country, homeaddress, password, dob) VALUES ('$username', '$email', '$phonenumber', '$country', '$homeaddress', '$password', '$dob')";
    $query_run = mysqli_query($connection, $query);
