...
?>
  <style>
    ...
    #preloader{
      background: #fff url('../load/runninggear.gif') no-repeat center center;
      background-size: 10%;
    ...
    <section class="Form my-4 mx-5">
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-lg-5" >
            <img class="img-fluid" style="height: 780px; max-height: auto; object-fit: cover;"src="../img/pet18.jpg" alt="Login Register Cover Picture">
          </div>
          <div class="col-lg-7 px-5 pt-5"><br>
